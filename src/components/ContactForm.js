...
export default function ContactForm() {
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    if (form.captcha !== captcha) return;

    try {
      const response = await fetch("https://tanvitransportbackend.onrender.com/api/sendMail", {
        method: "POST",
      ...
      setError("Error sending request. Please check your internet connection.");
    }
  };
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={touchStyle}>Get in Touch!</div>
      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
        ...
        <div style={rowStyle}>
          ...
          <textarea name="requirement" value={form.requirement} onChange={handleChange} placeholder="Requirement"
            style={{ ...inputStyle, minHeight: "40px", flex: "2 1 180px", resize: "vertical" }} required />
        </div>
        ...
        {/* Buttons */}
        <div style={{ display: "flex", gap: "18px", justifyContent: "center", marginTop: "8px", flexWrap: "wrap" }}>
      ...
      <div style={{ marginTop: "28px", textAlign: "center", color: "#909090" }}>
        ...
        <b>Office:</b> No.47, Beltola College Road, Bongaon, Guwahati, Assam, 781028, India
      </div>
    </div>
  );
}
...
const errorStyle = {
  color: "#e74c3c", marginBottom: "18px", fontWeight: "bold", textAlign: "center"
};
